...
class PersonResourceIT {
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().name(DEFAULT_NAME).age(DEFAULT_AGE);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().name(UPDATED_NAME).age(UPDATED_AGE);
        return person;
    }
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.name(UPDATED_NAME).age(UPDATED_AGE);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.name(UPDATED_NAME).age(UPDATED_AGE);
