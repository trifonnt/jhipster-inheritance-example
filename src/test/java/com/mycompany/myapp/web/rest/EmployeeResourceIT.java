...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().company(DEFAULT_COMPANY);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().company(UPDATED_COMPANY);
        return employee;
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.company(UPDATED_COMPANY);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.company(UPDATED_COMPANY);
