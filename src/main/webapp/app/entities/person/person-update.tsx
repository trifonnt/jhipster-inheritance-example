  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="inheritanceApp.person.home.createOrEditLabel" data-cy="PersonCreateUpdateHeading">
            <Translate contentKey="inheritanceApp.person.home.createOrEditLabel">Create or edit a Person</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('inheritanceApp.person.name')}
                id="person-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('inheritanceApp.person.age')}
                id="person-age"
                name="age"
                data-cy="age"
                type="text"
